...
func FanIn() {
	ch1, err := read("C:\\Users\\WISDOM\\Documents\\Python Codes\\GoLang\\Advanced Go Dev\\concurrency\\fan-in_fan-out-pattern\\file1.csv")

	if err != nil {
		panic(fmt.Errorf("error reading csv file: %v", err))
	}

	ch2, err := read("C:\\Users\\WISDOM\\Documents\\Python Codes\\GoLang\\Advanced Go Dev\\concurrency\\fan-in_fan-out-pattern\\file2.csv")
